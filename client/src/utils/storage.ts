...
export const saveGameId = (gameId: GameId) => set(GAME_ID_KEY, gameId);
export const getGameId = () => get(GAME_ID_KEY) as GameId | null;
export const clearGameId = () => remove(GAME_ID_KEY);

export const savePlayerId = (playerId: PlayerId) =>
  set(PLAYER_ID_KEY, playerId);
export const getPlayerId = () => get(PLAYER_ID_KEY) as PlayerId | null;
